...
@onready var wrap_width = (get_viewport_rect().size.x / 2) # This value is equal to the width of the player.
@onready var wrap_xpos = 256
...
#	Set height
	...
	set_position(Vector2(randi()%540 - 270, (-(Height+2)*96)))
